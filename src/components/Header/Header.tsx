import { backgroundBox, circle, pfpStyle, logoStyle, titleBox } from './HeaderStyle';
...
export default function Header() {
  ...
  return (
    <div>
      <Stack component={'section'} paddingTop={smallTopBar ? '8rem' : '6.7rem'} alignItems={'center'}>
        {/*The box component. */}
        <Box
          display={'flex'}
            ...
            isDesktop
              ? {
                  ...
                  '&::before': {
                    ...
                    width: '100%',
                    height: '100%',
                    backgroundImage: 'linear-gradient(-110deg, #e8cde500 36%, #27242E)',
                    zIndex: -1
                  }
                }
              : {
        ...
        >
          <Stack alignItems={'center'}>
            ...
            >
              <ContactButton title={language === 'en' ? 'Work With Me!' : 'Työskentele kanssani!'} link='#socials' />
            </Box>
          </Stack>
          {/*logos */}
          <img
