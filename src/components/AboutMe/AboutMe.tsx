    ...
    <div>
      <Box>
        <ScrollAnimation animateIn={'fadeInLeft'} duration={0.5} animateOnce={true}>
          ...
          >
            <ScrollAnimation animateIn={'fadeIn'} delay={300} duration={0.5} animateOnce={true}>
              <Typography variant='h2' sx={isTabletOrMobile ? { fontSize: '1.6rem' } : isVeryTiny ? { fontSize: 'calc(2vw + 2px)' } : { fontSize: '0.9rem' }}>
                {' '}
                {language === 'en'
                  ? `Hi! My name is Patrick Palmroos, and I'm student studying a Bachelor
                of Business Administration degree, specializing in Software
                Development. I am currently completing my last semester and hoping to graduate by Decemeber 2025. I love learning new things and continuously strive
                to develop my skills and grow as a person. I enjoy working with
                people, taking on new challenges, and learning from them!`
                  : `Hei! Nimeni on Patrick Palmroos, ja opiskelen tradenomi tietojenkäsittelyä Tampereen ammattikorkeakouluusa erikoistuen ohjelmistotuotantoon. Valmistun 2025 joulukuussa. Rakastan oppia uusia asioita ja pyrin jatkuvasti kehittämään taitojani sekä kasvamaan ihmisenä. Olen monissa eri asiakaspalvelu tilanteissa töitä tehneenä oppinut monia merkitseviä taitoja. Olen oma-aloitteinen ja nappaan kiinni haasteesta kuin haasteesta terävin hampain!`}
                <br />
                <br />{' '}
                {language === 'en'
