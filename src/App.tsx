                ...
                <Box>
                  ...
                  >
                    <Box marginTop={'4rem'}>
                      ...
                      >
                        <Title title={language === 'en' ? 'My Previous Projects' : 'Aiemmat Projektini'} />
                      </Box>
                    </Box>
                    <Projects />
                  </Box>
                  ...
                  >
                    <Stack
                      paddingRight={'1rem'}
                      paddingLeft={'3rem'}
                      paddingBottom={isTabletOrMobile ? '0rem' : mobileFooter ? '12rem' : smallTitle ? '6rem' : '2rem'}
                      alignItems={isTabletOrMobile ? 'flex-start' : 'center'}
                      height={isTabletOrMobile ? '40rem' : '40rem'}
                    >
                      <div id='aboutMe' />
                      <Box
                        marginTop={isTabletOrMobile ? '0rem' : smallTitle ? '8rem' : '3rem'}
                        marginLeft={isTabletOrMobile ? '0rem' : smallTitle ? '5rem' : '-1rem'}
                        marginRight={smallTitle ? '9rem' : '1.5rem'}
                        sx={isTabletOrMobile ? null : { width: '40rem' }}
                        marginBottom={isTabletOrMobile ? '0rem' : '1rem'}
                      >
                        <ScrollAnimation animateIn={'fadeInLeft'} duration={0.5} animateOnce={true}>
                          <Title title={language === 'en' ? 'About Me' : 'Tietoja Minusta'} line={!isTabletOrMobile} />
                        </ScrollAnimation>
                      </Box>
                      <AboutMe />
                    </Stack>
                    <Box paddingTop={isTabletOrMobile ? '6rem' : '0rem'}>{isTabletOrMobile ? <Line /> : null}</Box>
                    <Stack
                    ...
                    >
                      ...
                      <Box
                        marginLeft={isTabletOrMobile ? '0rem' : smallTitle ? '11rem' : '1rem'}
                        marginTop={'0rem'}
                        marginRight={smallTitle ? '9rem' : '1.5rem'}
                        sx={isTabletOrMobile ? null : { width: '45rem' }}
                        marginBottom={isTabletOrMobile ? '0rem' : smallerSkills ? '0rem' : '4rem'}
                      >
                        <ScrollAnimation animateIn={'fadeInRight'} delay={200} duration={0.5} animateOnce={true}>
                          <Title title={language === 'en' ? 'Skills' : 'Taidot'} line={!isTabletOrMobile} />
                        </ScrollAnimation>
                      </Box>
                  ...
                  <div id='work'>
                    <Box sx={isTabletOrMobile ? { backgroundColor: '#1e1d28' } : null}>
                      <Box marginLeft={smallTitle ? '11rem' : '1rem'} marginRight={smallTitle ? '9rem' : '1.5rem'} marginTop={smallTitle ? '4rem' : '2rem'}>
                        <ScrollAnimation animateIn={'fadeInLeft'} duration={0.5} animateOnce={true}>
                          <Title title={language === 'en' ? 'Work Experience' : 'Työkokemus'} />
                        </ScrollAnimation>
                      </Box>
                      <ScrollAnimation animateIn={'fadeInRight'} duration={0.5} delay={100} animateOnce={true}>
                        <WorkExperience />
                      </ScrollAnimation>
                    </Box>
                  </div>
                  <div id='education'>
                    <Box marginLeft={smallTitle ? '11rem' : '1rem'} marginRight={smallTitle ? '9rem' : '1.5rem'} marginTop={smallTitle ? '4rem' : '2rem'}>
                      <ScrollAnimation animateIn={'fadeInRight'} duration={0.5} delay={0} animateOnce={true}>
                        <Title title={language === 'en' ? 'Education' : 'Koulutus'} />
                      </ScrollAnimation>
                    </Box>
                    <Education />
                  </div>
                  ...
                  >
                    <Box marginLeft={'1rem'} marginBottom={mobileFooter ? '2rem' : '0.5rem'} marginRight={'2rem'} width={'30rem'}>
                      <Title title={language === 'en' ? 'Contact Me!' : 'Ota Yhteyttä!'} />
                    </Box>
